...
struct VideoItem: Identifiable, Codable, Hashable {
  ...
  static func == (lhs: VideoItem, rhs: VideoItem) -> Bool {
    return lhs.id == rhs.id && lhs.imageName == rhs.imageName && lhs.videoName == rhs.videoName
      && lhs.title == rhs.title && lhs.authorId == rhs.authorId && lhs.timestamp == rhs.timestamp
      && lhs.likeCount == rhs.likeCount && lhs.isLiked == rhs.isLiked
  }
}
